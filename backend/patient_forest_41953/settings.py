"""
Django settings for patient_forest_41953 project.
...
ROOT_URLCONF = 'patient_forest_41953.urls'
...
WSGI_APPLICATION = 'patient_forest_41953.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_forest_41953 API",
    "DESCRIPTION": "API documentation for patient_forest_41953 App",
    "VERSION": "v1",
}
